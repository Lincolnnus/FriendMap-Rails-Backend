Friendoc::Application.routes.draw do
  ...
  get '/api/rrlogin',to:"users#rrlogin"
  post'/api/photos', to:"photos#upload"
  get '/api/photos/:uid/cities', to:"photos#cities"
  get '/api/photos/:uid/provinces', to:"photos#provinces"
  get '/api/photos/:uid', to:"photos#my"
  get '/api/photos/:uid/city/:city', to:"photos#city"
  get '/api/photos/:uid/province/:province', to:"photos#province"
  get '/api/photos/:uid/friends', to:"photos#friends"
